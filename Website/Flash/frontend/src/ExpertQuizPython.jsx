...
function ExpertQuizPython() {
  const questions = [
    ...
    {
      question:
        "3. Which of the following is a correct way to open a file in Python and automatically close it after use?",
      options: [
        'file.open("filename.txt", "r")',
        'open("filename.txt", "r").close()',
    ...
    },
    {
      ...
      options: [
        ...
        "raise_exception CustomException()",
      ],
    ...
    {
      question:
        "11. What is the purpose of the `*args` and `**kwargs` in Python function definitions?",
      options: [
        "To specify required arguments",
        "To accept any number of positional and keyword arguments",
    ...
    {
      question:
        "15. What is the output of `print([i for i in range(5) if i % 2 == 0])`?",
  ...
  const handleAnswerSelect = (selectedAnswer) => {
    ...
    if (currentQuestionIndex >= questions.length - 1 && userId) {
      ...
      storeScore("ExpertQuizPython", score, userId);
    }
  };
...
export default ExpertQuizPython;
