...
function ExpertQuizJava() {
  const questions = [
    ...
    },
    {
      ...
      options: [
        "It means that the variable or method belongs to the class, not instances of the class",
        "It means that the variable or method can only be accessed by a single thread at a time",
        "It means that the variable or method can be accessed from any other class",
    ...
    },
    {
      ...
      options: [
        ...
        "It allows a method to have multiple return types",
      ],
      correctAnswer:
        "It allows a class to have multiple methods with the same name but different parameters",
    },
    ...
    },
    {
      ...
      options: [
        ...
        "`==` compares primitive data types, while `.equals()` compares objects",
        "`==` is used for assignment, while `.equals()` is used for comparison",
        "`==` is used for comparison, while `.equals()` is used for assignment",
      ],
      correctAnswer:
        "`==` compares object references, while `.equals()` compares object contents",
    },
    {
      question:
        "7. What is the purpose of the `try`, `catch`, and `finally` blocks in Java exception handling?",
      options: [
    ...
    },
    {
      ...
      options: [
        "Checked exceptions must be declared in the method signature or caught using a try-catch block, while unchecked exceptions do not have this requirement",
        "Unchecked exceptions must be declared in the method signature or caught using a try-catch block, while checked exceptions do not have this requirement",
        "Checked exceptions occur at compile-time, while unchecked exceptions occur at runtime",
        "Unchecked exceptions occur at compile-time, while checked exceptions occur at runtime",
      ],
      correctAnswer:
        "Checked exceptions must be declared in the method signature or caught using a try-catch block, while unchecked exceptions do not have this requirement",
    },
    {
      question:
        "9. What is the purpose of the `this` keyword in Java constructors?",
      options: [
        "To refer to the current class instance",
        "To refer to the parent class instance",
        "To refer to the subclass instance",
    ...
    },
    {
      ...
      options: [
        "To check if an object belongs to a specific class or interface",
    ...
    },
    {
      ...
      options: [
        ...
        "An abstract class can implement multiple interfaces, while an interface cannot extend a class",
    ...
    },
    {
      ...
      options: [
        "To define a default implementation for a method in an interface",
        "To specify the default package for a class",
        "To declare a default constructor for a class",
        "To specify default values for instance variables",
      ],
      correctAnswer:
        "To define a default implementation for a method in an interface",
    },
    {
      ...
      options: [
        "To declare a package for a class",
