...
function BeginnerQuizJava() {
  const questions = [
    ...
    {
      question:
        'What is the output of `System.out.println(Boolean.parseBoolean("True"));`?',
      options: ["true", "false", "Error", "None of the above"],
      correctAnswer: "true",
    },
    {
    ...
    },
    {
      ...
      options: [
        "== checks for reference, equals() checks for value",
        "== and equals() do the same thing",
        "== checks for value, equals() checks for reference",
        "None of the above",
      ],
